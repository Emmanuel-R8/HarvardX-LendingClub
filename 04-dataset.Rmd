...
+ a mode with a maximum around 1.25 / 1.5 being loans seemingly repaid in full (the mode is above 100% given the repayment of principal _and_ interest);

+ a second and third mode around 42% and -1%;
...
```{r NPV-distribution-subrating,fig.cap="Distribution of NPV (\\%) depending on rating",fig.width="15cm"}
