...
## FROM THE COMMAND LINE (Linux) in the project directory (where the Rmd files are)
## 
## THE `rebuild-pdf.sh` script CONTAINS THIS COMMAND:
## 
## R --no-restore --no-save \
##   -e 'rm(list = ls(all.names = TRUE)); bookdown::render_book("00-index.Rmd", output_format = "bookdown::pdf_book")'
```
