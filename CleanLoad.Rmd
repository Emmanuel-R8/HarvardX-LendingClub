...
```{r cl-load-lending-club,echo=FALSE,message=FALSE}
###################################################################################################
##
## LendingClub data
...
```{r cl-load-reformatted-paid,echo=FALSE,message=FALSE}
if (!exists("loans")) {
...
```{r create-working-set,echo=FALSE,message=FALSE}
nSamples <- nrow(loans)
...
```{r create-list-variables,echo=FALSE,message=FALSE}
###################################################################################################
##
