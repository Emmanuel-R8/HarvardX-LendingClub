...
```{r 05-02-load-dataset,message=FALSE}
# Cleanup and reload
...
```{r 05-02-cleanup-load-dataset,message=FALSE,echo=TRUE}
...
```{r 05-02-first-training-C,echo=TRUE,message=FALSE}
...
```{r 05-02-third-training-B-vars,echo=TRUE,message=FALSE}
NAsThirdTraining <-
  tibble(
