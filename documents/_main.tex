...
{\centering \includegraphics[width=0.7\linewidth]{_main_files/figure-latex/interest-over-time-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{_main_files/figure-latex/swap-rates-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{_main_files/figure-latex/margin-over-time-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{_main_files/figure-latex/business-volume-per-month-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{_main_files/figure-latex/funded-by-subgrade, -1} 
...
\begin{Highlighting}[numbers=left,,]
\KeywordTok{local}\NormalTok{(\{}
\NormalTok{  zipfips <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"datasets/csv/uszips.csv"}\NormalTok{)}
  
  \CommentTok{# Delete the last 2 digits of the zipcode and only keep relevant information}
\NormalTok{  zipfips <-}
\StringTok{    }\NormalTok{zipfips }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{as_tibble}\NormalTok{() }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{zip =} \KeywordTok{floor}\NormalTok{(zip }\OperatorTok{/}\StringTok{ }\DecValTok{100}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{select}\NormalTok{(zip, state_id, population, county_fips, county_name)}
  
  \KeywordTok{saveRDS}\NormalTok{(zipfips, }\StringTok{"datasets/zipfips.rds"}\NormalTok{)}
\NormalTok{\})}
\end{Highlighting}
\end{Shaded}
...
\StringTok{    }\KeywordTok{arrange}\NormalTok{(FIPS) }\OperatorTok{%>%}
\StringTok{    }
\StringTok{    }\CommentTok{# Transpose the table to have the FIPS as columns, and the years as observations}
\StringTok{    }\KeywordTok{t}\NormalTok{()}
  
  \CommentTok{# After the transpose, correct the name of the columns by using the first row (from which blanks are removed)}
  \KeywordTok{colnames}\NormalTok{(medianIncome) <-}\StringTok{ }\NormalTok{medianIncome[}\DecValTok{1}\NormalTok{, ] }\OperatorTok{%>%}\StringTok{ }\KeywordTok{str_remove}\NormalTok{(}\StringTok{"[ ]"}\NormalTok{)}
  
  \CommentTok{# Create a new column with the name of the year and converts to tible}
\NormalTok{  medianIncome <-}
\StringTok{    }\KeywordTok{cbind}\NormalTok{(}\DataTypeTok{Year =} \KeywordTok{rownames}\NormalTok{(medianIncome), medianIncome) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{as_tibble}\NormalTok{() }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{slice}\NormalTok{(}\DecValTok{2}\OperatorTok{:}\KeywordTok{n}\NormalTok{())}
  
  \CommentTok{# Converts the content of the Year column to an actual date}
\NormalTok{  medianIncome <-}\StringTok{ }\NormalTok{medianIncome }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Year =} \KeywordTok{str_replace}\NormalTok{(Year, }\StringTok{"[X]"}\NormalTok{, }\StringTok{""}\NormalTok{),}
           \DataTypeTok{Year =} \KeywordTok{ymd}\NormalTok{(}\KeywordTok{str_c}\NormalTok{(Year, }\StringTok{"-12-31"}\NormalTok{)))}
...
\StringTok{    }\KeywordTok{t}\NormalTok{()}
  ...
  \CommentTok{# Correct the name of the columns after the transpose}
  \KeywordTok{colnames}\NormalTok{(personalIncome) <-}
\StringTok{    }\NormalTok{personalIncome[}\DecValTok{1}\NormalTok{, ] }\OperatorTok{%>%}\StringTok{ }\KeywordTok{str_remove}\NormalTok{(}\StringTok{"[ ]"}\NormalTok{)}
  
  \CommentTok{# Create a new column with the name of the year and converts to tible}
\NormalTok{  personalIncome <-}
\StringTok{    }\KeywordTok{cbind}\NormalTok{(}\DataTypeTok{Year =} \KeywordTok{rownames}\NormalTok{(personalIncome), personalIncome) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{as_tibble}\NormalTok{() }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{slice}\NormalTok{(}\DecValTok{2}\OperatorTok{:}\KeywordTok{n}\NormalTok{())}
  
  \CommentTok{# Converts the content of the Year column to an actual date}
\NormalTok{  personalIncome <-}\StringTok{ }\NormalTok{personalIncome }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Year =} \KeywordTok{str_replace}\NormalTok{(Year, }\StringTok{"[X]"}\NormalTok{, }\StringTok{""}\NormalTok{),}
           \DataTypeTok{Year =} \KeywordTok{ymd}\NormalTok{(}\KeywordTok{str_c}\NormalTok{(Year, }\StringTok{"-12-31"}\NormalTok{)))}
...
\StringTok{    }\KeywordTok{t}\NormalTok{()}
  ...
  \CommentTok{# Correct the name of the columns after the transpose}
  \KeywordTok{colnames}\NormalTok{(unemploymentRate) <-}
\StringTok{    }\NormalTok{unemploymentRate[}\DecValTok{1}\NormalTok{, ] }\OperatorTok{%>%}\StringTok{ }\KeywordTok{str_remove}\NormalTok{(}\StringTok{"[ ]"}\NormalTok{)}
  
  \CommentTok{# Create a new column with the name of the year and converts to tible}
\NormalTok{  unemploymentRate <-}
\StringTok{    }\KeywordTok{cbind}\NormalTok{(}\DataTypeTok{Year =} \KeywordTok{rownames}\NormalTok{(unemploymentRate), unemploymentRate) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{as_tibble}\NormalTok{() }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{slice}\NormalTok{(}\DecValTok{2}\OperatorTok{:}\KeywordTok{n}\NormalTok{())}
  
  \CommentTok{# Converts the content of the Year column to an actual date}
\NormalTok{  unemploymentRate <-}\StringTok{ }\NormalTok{unemploymentRate }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}
      \DataTypeTok{Year =} \KeywordTok{str_replace}\NormalTok{(Year, }\StringTok{"[X]"}\NormalTok{, }\StringTok{""}\NormalTok{),}
      \DataTypeTok{Year =} \KeywordTok{str_replace}\NormalTok{(Year, }\StringTok{"[.]"}\NormalTok{, }\StringTok{"-"}\NormalTok{),}
      \DataTypeTok{Year =} \KeywordTok{ymd}\NormalTok{(}\KeywordTok{str_c}\NormalTok{(Year, }\StringTok{"-1"}\NormalTok{))}
\NormalTok{    )}
...
\NormalTok{##                                       "Linux" }
\NormalTok{##                                       release }
\NormalTok{##                            "5.3.0-20-generic" }
\NormalTok{##                                       version }
\NormalTok{## "#21-Ubuntu SMP Wed Oct 23 16:20:37 UTC 2019" }
\NormalTok{##                                      nodename }
\NormalTok{##                                        "x260" }
\NormalTok{##                                       machine }
\NormalTok{##                                      "x86_64" }
