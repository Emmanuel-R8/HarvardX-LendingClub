...
```{r 05-01-cleanup,echo=FALSE,message=TRUE}
# Not used later on
...
It is considered that information value below 2% is useless. The 15 best variables (in terms of Information Value) are:
