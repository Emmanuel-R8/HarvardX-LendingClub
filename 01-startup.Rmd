...
indicatorsFromZIPandDate <- function(zip3d, application_date) {
  ...
  emptyResult <-   tibble(unemployment = 0, medianIncome = 0, personalIncome = 0)

    
  if (!is.numeric(zip3d)) return(emptyResult)
  if (!is.Date(application_date)) return(emptyResult)
...
```{r list-of-variables}
# Generated from a LibreOffice spreadsheet for convenience purposes, then reformatted by RStudio.
