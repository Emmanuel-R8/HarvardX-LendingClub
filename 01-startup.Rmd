...
LC_variable <-
  ...
  add_row(
    ...
    description = 'The initial listing status of the loan. Possible values are – W,
  F',
  inModel = FALSE,
  inPrediction = FALSE,
  inPricing = TRUE
  ...
  add_row(
    ...
    description = 'Months since most recent 90 -
    day or worse rating',
    inModel = FALSE,
    inPrediction = FALSE,
    inPricing = TRUE
  ...
  add_row(
    ...
    description = 'Publicly available policy_code =
    1 / New products not publicly available policy_code = 2',
    inModel = FALSE,
    inPrediction = FALSE,
    inPricing = TRUE
  ) %>%
  add_row(
    ...
    description = 'Indicates whether the loan is an individual application or a joint application with two co -
    borrowers',
    inModel = TRUE,
    inPrediction = FALSE,
    inPricing = TRUE
  ...
  add_row(
    ...
    description = 'Indicates if income was verified by LC,
  not verified,
  ...
  add_row(
    ...
    description = 'Ratio of total current balance to high credit /
  ...
  add_row(
    ...
    description = 'Total revolving high credit /
    credit limit',
    inModel = FALSE,
    inPrediction = FALSE,
    inPricing = TRUE
  ...
  add_row(
    ...
    description = 'Number of revolving trades with balance >
    0',
    inModel = TRUE,
    inPrediction = FALSE,
    inPricing = TRUE
  ...
  add_row(
    ...
    description = 'Number of open trades at time of application for the secondary applicant',
    inModel = TRUE,
    inPrediction = FALSE,
    inPricing = TRUE
  ) %>%
  add_row(
    ...
    description = 'Ratio of total current balance to high credit/credit limit for all revolving accounts',
    inModel = TRUE,
    inPrediction = FALSE,
    inPricing = TRUE
  ) %>%
